...
namespace EnhancedBuildPanel.GUI
{
    public class UIPrefabItem : UIPanel
    {
            ...
            
        {
            ...
            m_textureSize.text = (m_meshData.textureSize != Vector2.zero)
                ? m_meshData.textureSize.x + "x" + m_meshData.textureSize.y
                : "-";
            m_lodTextureSize.text = (m_meshData.lodTextureSize != Vector2.zero)
                ? m_meshData.lodTextureSize.x + "x" + m_meshData.lodTextureSize.y
                : "-";
        ...
        public override void Start()
        {
         //   base.Start();
            ...
            m_name.eventDoubleClick += (c, t) =>
            {
                ...
                {
                    var publishedFileId = new PublishedFileId((ulong) int.Parse(m_steamID.text));
